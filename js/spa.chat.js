...
spa.chat = (function () {
    ...
    var configMap = {
        ...
        setSliderPosition, writeChat, writeAlert, clearChat,
        configModule, initModule,
        removeSlider, handleResize,
        onTapToggle, onSubmitMsg, onTabList,
    ...
    setPxSizes = function () {
        ...
        window_height_em = Math.floor(
            (jqueryMap.$window.height() / px_per_em) + 5
        );
    ...
    onUpdatechat = function (event, msg_map) {
        var is_user, sender_id = msg_map.sender_id,
            msg_text = msg_map.msg_text, chatee = configMap.chat_model.get_chatee() || {},
    ...
    setSliderPosition = function (position_type, callback) {
        ...
        if (stateMap.position_typt === position_type) {
    ...
    initModule = function ($append_target) {
        ...
        jqueryMap.$list_box.bind('utap', onTabList);
